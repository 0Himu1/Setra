...
export default function Navbar() {
  ...
  return (
    <>
      <nav className=" bg-dimWhite px-5 py-6 divide-y shadow-lg text-dimBlack md:px-20 md:py-5 border-b-[1px] xl:px-[168px]">
      ...
      <div className={`w-full ${onSmallScreen ? '' : 'hidden'}`}>
